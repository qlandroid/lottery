/** layui-v1.0.9-rls MIT License By http://www.layui.com */
;
!function (e) {
    "use strict";
    var t = function () {
    ...
    }, a = "undefined" != typeof opera && "[object Opera]" === opera.toString(), l = {
        layer: "modules/layer",
    ...
    o.modules = {}, o.status = {}, o.timeout = 10, o.event = {}, t.fn.define = function (e, t) {
        ...
        var a = this, l = n.createElement("link"), u = n.getElementsByTagName("head")[0];
        "string" == typeof t && (i = t);
        ...
        var i = this, r = null, a = t.match(/\(.*\)$/) || [], l = (t = e + "." + t).replace(a, ""), u = function (e, t) {
            var o = t && t.call(i, n);
            o === !1 && null === r && (r = !1)
        };
