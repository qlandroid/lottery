...
public class MakeManifestNo {
	...
	private static MakeManifestNo instance;

	public static MakeManifestNo getInstance() {
		if (instance == null) {
			synchronized (MakeManifestNo.class) {
				if (instance == null) {
					instance = new MakeManifestNo();
				}
			}
		}
		return instance;
